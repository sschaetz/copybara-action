...
export const exitCodes: {
  ...
  52: {
    msg: "Unexpected error running Copybara. Please open an issue on schaetz/copybara-action.",
    ns: "action",
    type: "error",
  },
  53: {
    msg: "Unexpected error. Please open an issue on schaetz/copybara-action.",
    ns: "action",
    type: "error",
  },
  54: {
