...
jobs:
  move-code:
    ...
    steps:
      ...
      - uses: sschaetz/copybara-action@v0.2.1
        with:
...
> You can experiment with our [playground repo template](https://github.com/sschaetz/copybara-playground) to try various scenarios before you implement it in your own repo.
